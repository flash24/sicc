...
<?php echo $this->Form->create('CursosAbierto'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cursos Abierto'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CursosAbierto.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CursosAbierto.id'))); ?></li>
